getgenv().SettingsGui = {
	["GenColor"] = Color3.fromRGB(255, 172, 28),
	["GenName"] = "RobloxGui_HUD",
}

local Players,Client,VirtualInputManager,CoreGui,UserInputService,TweenService,RunService,Mouse,HttpService do
...
ImageButton.MouseButton1Down:connect(function()
	VirtualInputManager:SendKeyEvent(true,305,false,game)
	VirtualInputManager:SendKeyEvent(false,305,false,game)
end)
...
if CoreGui:FindFirstChild(getgenv().SettingsGui["GenName"]) then
	CoreGui:FindFirstChild(getgenv().SettingsGui["GenName"]):Destroy()
end
...
pfp = userinfo["pfp"] or "https://www.roblox.com/headshot-thumbnail/image?userId=".. Client.UserId .."&width=420&height=420&format=png"
user =  userinfo["user"] or Client.Name
...
RadientPaidSC.Name = getgenv().SettingsGui["GenName"]
RadientPaidSC.Parent = CoreGui
...
function RadientPaid:Window(text,maincolor)
	...
	UserTag.TextColor3 = getgenv().SettingsGui["GenColor"]
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		ResetBtn.MouseButton1Click:Connect(function()
			pfp = "https://www.roblox.com/headshot-thumbnail/image?userId=".. Client.UserId .."&width=420&height=420&format=png"
			UserImage.Image = pfp
			UserPanelUserImage.Image = pfp
			SaveInfo()
	...
	function RadientPaid:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.MouseEnter:Connect(function()
			TweenService:Create(
				AlrightBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = getgenv().SettingsGui["GenColor"]}
			):Play()
		end)
	...
	function ServerHold:Server(text,textgame, img)
		...
		Server.TextColor3 = getgenv().SettingsGui["GenColor"]
		...
		ServerTitle.TextColor3 = getgenv().SettingsGui["GenColor"]
		...
		function ChannelHold:Channel(text)
			...
			ChannelHolder.ScrollBarImageColor3 = getgenv().SettingsGui["GenColor"]
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						...
						TweenService:Create(ToggleFrame,TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundColor3 = getgenv().SettingsGui["GenColor"]}):Play()
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				SliderTitle.BackgroundColor3 = getgenv().SettingsGui["GenColor"]
				...
				CurrentValueFrame.BackgroundColor3 = getgenv().SettingsGui["GenColor"]
			...
			function ChannelContent:Dropdown(text, list, default, callback)
				...
				CurrentSelectedText.Text = (getpro() or "....")
				...
				DropItemHolder.ScrollBarImageColor3 = getgenv().SettingsGui["GenColor"]
