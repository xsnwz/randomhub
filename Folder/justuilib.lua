...
library.new = function(info)
	...
	utils.create("UIGradient", {
		Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 0)), ColorSequenceKeypoint.new(0.92, Color3.fromRGB(56, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(95, 0, 0))},
		Rotation = 86,
	...
	function library.tab.tab(info)
		...
		ButtonTap.MouseButton1Click:Connect(function()
			...
			UIGradient.Color = ColorSequence.new{
				ColorSequenceKeypoint.new(0, Color3.fromRGB(213, 0, 0)),
		...
		library.page.page = function(info)
			...
			library.FuncMain.Button = function(info)
				...
				utils.create("UIGradient", {
					Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(213, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(179, 0, 0))},
					Rotation = 86,
					Transparency = NumberSequence.new{NumberSequenceKeypoint.new(0.00, 0.54), NumberSequenceKeypoint.new(1.00, 0.00)},
					Parent = buttonbar,
				})
				...
				utils.create("UIGradient", {
					Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(130, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(76, 0, 0))},
					Parent = UIStroke,
				})
			...
			library.FuncMain.Slider = function(info)
				...
				utils.create("UIGradient", {
					Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(213, 0, 0)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(50, 0, 0))},
					Rotation = 90,
					Parent = Frame_2,
				})
